...
// 👆 Uses your deployed URL in production, falls back to localhost for local dev
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-700 p-3 pl-10 rounded-lg outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div className="relative">
                ...
                <select
                  name="role"
                  className="w-full bg-gray-700 p-3 pl-10 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 appearance-none text-gray-300"
                  onChange={handleChange}
                  value={formData.role}
                >
                ...
                <>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-700 border border-green-500/30 p-3 pl-10 rounded-lg outline-none focus:ring-2 focus:ring-green-500"
                      onChange={handleChange}
                      required
                    />
                  </div>
                  <div className="relative">
                    ...
                    <input
                      name="vehicleNumber"
                      type="text"
                      placeholder="Vehicle Number (e.g. DL-102)"
                      className="w-full bg-gray-700 border border-blue-500/30 p-3 pl-10 rounded-lg outline-none focus:ring-2 focus:ring-blue-500"
                      onChange={handleChange}
                      required
                    />
                  </div>
              ...
              {formData.role !== 'citizen' && (
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-800 border border-red-500/50 p-3 pl-10 rounded-lg outline-none focus:ring-2 focus:ring-red-500"
                    onChange={handleChange}
                    required
                  />
                </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-blue-600 to-blue-500 py-3 rounded-lg font-bold shadow-lg hover:from-blue-500 hover:to-blue-400 transition"
          >
